	...
	<form action="/search/node" method="post" id="search-block-form" accept-charset="UTF-8">
		...
		<div class="container-inline">
		    ...
		    <div class="form-item form-type-textfield form-item-search-block-form">
		 		...
		 		<input title="请输入您想搜索的关键词。" type="text" id="edit-search-block-form--2" name="search_block_form" value="" size="15" maxlength="198" class="form-text" placeholder="搜索你喜欢的">
			</div>
...
<div id="block-block-10-content">
	<ul class="fenlan-topic-list">
		<?php echo get_all_fenlan_article(); ?>
	</ul>
</div>
